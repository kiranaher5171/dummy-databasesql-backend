...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blog_category: Schema.Attribute.String;
    blog_description: Schema.Attribute.Text;
    blog_slug: Schema.Attribute.UID<'blog_title'>;
    blog_thumbnail: Schema.Attribute.Media<'images'>;
...
export interface ApiContactUsContactUs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    hear_about_us: Schema.Attribute.Enumeration<
